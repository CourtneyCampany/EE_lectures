...
* **Carbon gain from forest floor to top of canopy**
  + <strong><span style="color:green">total leaf area is key<strong><span style="color:green">
</div>
...
<IMG STYLE="position:absolute; TOP:150px; LEFT:75px; WIDTH:900px; HEIGHT:500px" SRC="images/gpp_wue.png">
...
* **Projected leaf area per unit ground area**
  ...
  + determines how much area for light abosoprtion/C uptake

  + determines light extinction through canopy
...
<IMG STYLE="position:absolute; TOP:250px; LEFT:600px; WIDTH:400px; HEIGHT:300px" SRC="images/lai_vis.png">
